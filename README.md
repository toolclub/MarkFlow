...
<p align="center">
  <a href="https://github.com/toolclub/MarkFlow/releases/latest"><img src="https://img.shields.io/badge/version-1.0.0-6366f1?style=flat-square" alt="version"></a>
...
<p align="center">
  <a href="https://github.com/toolclub/MarkFlow/releases/download/v1.0.0/MarkFlow-Setup-1.0.0.exe">
  ...
  &nbsp;
  <a href="https://github.com/toolclub/MarkFlow/releases/download/v1.0.0/MarkFlow-1.0.0.dmg">
  ...
  &nbsp;
  <a href="https://github.com/toolclub/MarkFlow/releases/download/v1.0.0/MarkFlow-1.0.0.AppImage">
...
| 平台 | 文件 | 说明 |
|------|------|------|
| Windows | `MarkFlow-Setup-1.0.0.exe` | NSIS 安装器，支持自定义安装目录 |
| macOS | `MarkFlow-1.0.0.dmg` | 拖入 Applications 即可 |
| Linux | `MarkFlow-1.0.0.AppImage` | `chmod +x` 后直接运行 |
| Linux | `markflow_1.0.0_amd64.deb` | Debian/Ubuntu: `sudo dpkg -i` |
